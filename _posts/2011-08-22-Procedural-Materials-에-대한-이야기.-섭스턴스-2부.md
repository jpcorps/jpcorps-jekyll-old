...
Since the complexity of a Procedural Material can affect runtime performance, Allegorithmic incorporates profiling features in its *Substance Player* tool. This tool is available to download for free from [Allegorithmic뭩 website](https://www.allegorithmic.com/).
