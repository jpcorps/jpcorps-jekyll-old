...
![](file:///C:/Program%20Files/Unity/Editor/Data/Documentation/Documentation/Images/manual/RenderingStatistics-0.jpg)  
*Rendering Statistics Window.*
...
| Tris and Verts | Number of triangles and vertices drawn. This is mostly important when [optimizing for low-end hardware](file:///C:/Program%20Files/Unity/Editor/Data/Documentation/Documentation/Manual/OptimizeForIntegratedCards.html) |
| Used Textures | Count and memory size of textures used when drawing this frame. |
| Render Textures | Count and memory size of [Render Textures](file:///C:/Program%20Files/Unity/Editor/Data/Documentation/Documentation/Components/class-RenderTexture.html) that are created. Also displays how many times active Render Texture was switched during this frame. |
