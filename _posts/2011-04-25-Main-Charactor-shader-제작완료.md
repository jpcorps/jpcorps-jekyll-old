...
![](/assets/images/posts/20110425_c0055803_4db4e63498478.png)우선 기존의 쉐이더를 보겠습니다.   
기본으로 들어있는 쉐이더인 Bumped Diffuse.  
말그대로 노말맵과 Base Texture만 있는 기본쉐이더.   
  
![](/assets/images/posts/20110425_c0055803_4db4c9f81a220.png)![](/assets/images/posts/20110425_c0055803_4db4c9f914d7f.png)![](/assets/images/posts/20110425_c0055803_4db4cab44d113.png)  
  
일단, 기본쉐이더는 너무 어두워서 쓸 수가 없습니다. Main Color를 가장 밝게 한 것임에도 불구하고.   
그래서 기본 쉐이더를 쓰려면 어쩔 수 없이 Self illumination 쉐이더를 사용해야지요.   
  
![](/assets/images/posts/20110425_c0055803_4db4cac0dd981.png)Self - illumination 쉐이더중 Bumped specular 입니다. 좀 밝아졌고, (여기서 더 올리면 타버립니다) 노말맵도 허벅지나 스카프 등에서 좀 보입니다만 여전히 너무 어둡고 배경과 이질감이 납니다.   
  
아마 쉐이더 관리자가 없는 회사라면, 여기서 끝나는게 정상일 겁니다.   
그렇지만 우린 아니지요.   
그럼 이제 본격적 분석 들어갑니다.   
  
![](/assets/images/posts/20110425_c0055803_4db4cb90987ac.png)이 쉐이더에서 텍스쳐만 없애본 상태입니다. (그냥 없애기만 하면 하얗게 날라가기 때문에 약간 main color를 낮췄습니다)   
...
![](/assets/images/posts/20110425_c0055803_4db4d060a706c.jpg)
...
![](/assets/images/posts/20110425_c0055803_4db4d1f57efc2.png)새로 만든 쉐이더. Specular도 없이 그냥 Diffuse 상태입니다. 노말맵만 적용된. 이번엔 라이팅도 특별하게 제작하지 않고, 기본 라이팅을 사용하였습니다. (그래야 호환성이 좋아요)  
  
여기에 위에서 말한 천반구 조명을 추가해 보겠습니다.   
![](/assets/images/posts/20110425_c0055803_4db4d2e14da41.png)여기의 하늘은... 약간 녹색끼가 추가된 파랑색이로군요. 그리고 사막 지형이라 공기가 맑고, 강하게 내리쬘 겁니다. 이런 경우에는 보통 천반구의 색 영향이 강하게 들어오지요. 좀 강하게 넣어 보겠습니다.   
  
![](/assets/images/posts/20110425_c0055803_4db4d3ae90ab7.png)![](/assets/images/posts/20110425_c0055803_4db4d3d52e188.png)영향을 좀 더 잘 보이게 하기 위해 그늘로 자리를 옮겼습니다.   
그리고 천반구(하늘) 색을 넣어 보았습니다.   
음영진 부분이어서 노말이 전혀 보이지 않던 부분까지도 노말이 보이기 시작합니다.   
  
![](/assets/images/posts/20110425_c0055803_4db4d455d2352.png)![](/assets/images/posts/20110425_c0055803_4db4d46982ffb.png)이번엔 반대로 지반구(땅 색깔) 을 추가!   
...
![](/assets/images/posts/20110425_c0055803_4db4d58b94bf0.png)이 스페큘라를 더하면  
  
![](/assets/images/posts/20110425_c0055803_4db4d74177c09.png)  
이렇게 됩니다.   
...
![](/assets/images/posts/20110425_c0055803_4db4d85169db3.png)즉 이렇게 말입니다. 반구조명 색상의 영향을 받고, 거기에 다시 스페큘러 색상이 곱해집니다. 흰색으로 하게되면 위와 같이 되겠지요.   
  
이렇게 된 결과물을 다시 더하면,   
  
![](/assets/images/posts/20110425_c0055803_4db4d93d3f228.png)좀 더 복잡미묘한 결과물이 됩니다.   
노말맵도 좀 더 확실히 보이구요.   
...
![](/assets/images/posts/20110425_c0055803_4db4da5f22df7.png)이렇게요.   
...
![](/assets/images/posts/20110425_c0055803_4db4db0746b03.png)![](/assets/images/posts/20110425_c0055803_4db4db282c9bf.png)이제 여기에 텍스쳐를 곱해줍니다.   
  
(텍스쳐 \* 디렉셔널 라이트 \* 반구조명) + 스페큘러 + 가짜 스페큘러 + 림라이트   
  
![](/assets/images/posts/20110425_c0055803_4db4deb0ada72.png)  
여기에 마지막으로 리플렉션!!!   
...
일단 노말맵 색상 자체가 다릅니다.   
이렇게 생겼어요   
![](/assets/images/posts/20110425_c0055803_4db4dfe110949.jpg)**파랑색이 빠져 있습니다!** 이유는 노말맵이 만들어 지고나서 R과 G는 그냥 사용하지만, B 채널은 사실 거의 1값이기 때문에 계산에 큰 영향을 끼치지 않기 때문인데요, 때문에 공식 자체가 R과 G를 계산하지만 B는 그냥 1이라고 강제로 넣어버리는 방식으로 되어 있습니다.   
...
![](/assets/images/posts/20110425_c0055803_4db4e0b405dae.png)이렇게 해서 채널 하나를 절약할 수 있게 되는 거지요..   
  
하지만 이 때문에 정말 중요한 한 가지가 있습니다!  
**우리 노말맵은 노말맵이 아니라 텍스쳐라는 것입니다!**   
  
유니티 이녀석이, 텍스쳐 타입을 노말맵으로 하면...   
![](/assets/images/posts/20110425_c0055803_4db4dfb9b0321.jpg)자기 멋대로 노말맵 계산 공식을 내부에서 만들어 버려서, blue 값을 다른데 사용할 수가 없게 만들어 버립니다. 마구 뒤섞더군요.   
...
이것때문에 조금 불편한게 생겼는데요.   
아래 그림을 보시죠.   
![](/assets/images/posts/20110425_c0055803_4db4e22c165ee.png)**어깨와 가슴을 리플렉션을 주기 위해 마스킹 설정을 한 것을 알 수 있는데요,   
...
어쨌건 리플렉션 마스킹 추가.   
![](/assets/images/posts/20110425_c0055803_4db4e3a838a6c.png)금속이 반짝반짝.   
기본 텍스쳐와 곱해집니다.   
이건 움직여야 이뻐요 ㅋ  
  
![](/assets/images/posts/20110425_c0055803_4db4e3eaadaa8.png)이렇게 리플렉션까지 연산되어 나온 최종 결과물.   
  
![](/assets/images/posts/20110425_c0055803_4db4c892700e6.png)![](/assets/images/posts/20110425_c0055803_4db4e4e1c731a.png)밝은 빛 아래에서. 좀 타긴 합니다. 블룸값 수정을 해야 할지도.   
  
![](/assets/images/posts/20110425_c0055803_4db4e4e4865a8.png)그늘로 들어가도 라이팅 디테일이 잘 보입니다.   
  
![](/assets/images/posts/20110425_c0055803_4db4e4e3a9039.png)  
등짝을 보자.   
  
![](/assets/images/posts/20110425_c0055803_4db4e4e6743af.png)  
멀리서 봐도 잘 보입니다.   
  
![](/assets/images/posts/20110425_c0055803_4db4e63498478.png)  
