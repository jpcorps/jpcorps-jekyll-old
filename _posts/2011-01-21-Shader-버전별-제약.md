...
layout: post
title: "Shader 버전별 제약"
date: 2011-01-21 13:35:13
categories: [이글루스 백업, "2011-01"]
---

퍼옴 : <https://en.wikipedia.org/wiki/High_Level_Shader_Language>

### PIXEL shader comparison

| Pixel shader version | 2.0 | 2.0a | 2.0b | 3.0[[2]](https://www.egloos.com/egloo/insert.php?eid=c0055803#cite_note-SM3-1) | 4.0[[3]](https://www.egloos.com/egloo/insert.php?eid=c0055803#cite_note-D3D10-2) |
| --- | --- | --- | --- | --- | --- |
...
| Arbitrary [swizzling](https://www.egloos.com/wiki/Swizzling_(computer_graphics) "Swizzling (computer graphics)") | No | Yes | No | Yes | Yes |
...
* **PS 2.0a** = NVIDIA [GeForce FX](https://www.egloos.com/wiki/GeForce_FX "GeForce FX")-optimized model.
* **PS 2.0b** = ATI [Radeon X700, X800, X850](https://www.egloos.com/wiki/Radeon_R420 "Radeon R420") shader model, DirectX 9.0b.
...
| Vertex shader version | VS 2.0 | VS 2.0a | VS 3.0[[2]](https://www.egloos.com/egloo/insert.php?eid=c0055803#cite_note-SM3-1) | VS 4.0[[3]](https://www.egloos.com/egloo/insert.php?eid=c0055803#cite_note-D3D10-2) |
| --- | --- | --- | --- | --- |
| # of instruction slots | 256 | 256 | ≥ 512 | 4096 |
| Max # of instructions executed | 65536 | 65536 | 65536 | 65536 |
| [Instruction predication](https://www.egloos.com/wiki/Branch_predication "Branch predication") | No | Yes | Yes | Yes |
...
| [Geometry instancing](https://www.egloos.com/wiki/Geometry_instancing "Geometry instancing") support | No | No | Yes | Yes |
| Bitwise Operators | No | No | No | Yes |
| Native Integers | No | No | No | Yes |

* **VS 2.0** = DirectX 9.0 original **Shader Model** specification.
* **VS 2.0a** = NVIDIA [GeForce FX](https://www.egloos.com/wiki/GeForce_FX "GeForce FX")-optimized model.
